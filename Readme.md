...
## Solid pourquoi ?
L'idée sous jaccente des principes SOLID est de rendre résilant les entités logiciels. Elles doivent être en mesure de s'adapter aux évolutions sans qu'il soit nécessaire de les modifier. L'idée étant de limiter au maximum le nombre de modification à faire. 
